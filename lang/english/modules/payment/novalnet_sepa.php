...
define('MODULE_PAYMENT_NOVALNET_SEPA_TEXT_DESCRIPTION', '<br>Your account will be debited upon the order submission<br />');
define('MODULE_PAYMENT_NOVALNET_SEPA_PUBLIC_TITLE', (((!defined('MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY')) || MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY == 'True')?'<a href="https://www.novalnet.com/sepa-direct-debit" title="Direct Debit SEPA" target="_blank"/>'.xtc_image(DIR_WS_ICONS.'novalnet/novalnet_sepa.png', "Direct Debit SEPA").'</a>':''));
...
define('MODULE_PAYMENT_NOVALNET_SEPA_SAVECARD_DETAILS', 'Save my account details for future purchases');

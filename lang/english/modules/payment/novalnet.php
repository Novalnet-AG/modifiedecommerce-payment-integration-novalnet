...
define('MODULE_PAYMENT_NOVALNET_CASH_PAYMENT_TRANS_UPDATED_MESSAGE', 'The transaction has been updated with amount ( %s ) and slip expiry date with %s');
...
define('MODULE_PAYMENT_NOVALNET_ONECLICK_SEPA_REF', 'Enter new account details');
...
define('MODULE_PAYMENT_NOVALNET_ENABLE_MODULE_TITLE', 'Enable payment method');
...
define('MODULE_PAYMENT_NOVALNET_PENDING_ORDER_STATUS_TITLE', 'Order status for the pending payment');
...
define('MODULE_PAYMENT_NOVALNET_REDIRECT_NOTICE_MSG', 'Please don&#39;t close the browser after successful payment, until you have been redirected back to the Shop<br/> ');
...
define('MODULE_PAYMENT_NOVALNET_GUARANTEE_MIN_AMOUNT_TITLE', 'Minimum order amount (in minimum unit of currency. E.g. enter 100 which is equal to 1.00)');
define('MODULE_PAYMENT_NOVALNET_GUARANTEE_MIN_AMOUNT_DESC', 'This setting will override the default setting made in the minimum order amount. Note that amount should be in the range of 9,99 EUR');
...
define('MODULE_PAYMENT_NOVALNET_GUARANTEE_FORCE_DESC', 'If the payment guarantee is activated (True), but the above mentioned requirements are not met, the payment should be processed as non-guarantee payment.');
define('MODULE_PAYMENT_NOVALNET_FORCE_GUARANTEE_ERROR_MESSAGE_COUNTRY', '<span style="color:red;">The payment cannot be processed, because the basic requirements for the payment guarantee haven&#39;t been met (Only Germany, Austria or Switzerland are allowed)</span>');
...
The payment cannot be processed, because the basic requirements for the payment guarantee haven&#39;t been met (Minimum order amount must be %s )</span>');
define('MODULE_PAYMENT_NOVALNET_CONFIRM_TEXT', 'Confirm');

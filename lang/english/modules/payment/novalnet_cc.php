...
define('MODULE_PAYMENT_NOVALNET_CC_ENFORCE_3D_TITLE', 'Enforce 3D secure payment outside EU');
define('MODULE_PAYMENT_NOVALNET_CC_ENFORCE_3D_DESC', 'By enabling this option, all payments from cards issued outside the EU will be authenticated via 3DS 2.0 SCA.');

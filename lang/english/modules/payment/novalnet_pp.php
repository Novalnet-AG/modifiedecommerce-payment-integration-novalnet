...
define('MODULE_PAYMENT_NOVALNET_PP_TEXT_DESCRIPTION', '<br>After the successful verification, you will be redirected to Novalnet secure order page to proceed with the payment<br />');
define('MODULE_PAYMENT_NOVALNET_PP_PUBLIC_TITLE', (((!defined('MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY')) || MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY == 'True') ? '<a href="https://www.novalnet.com/paypal" title="PayPal" target="_blank"/>'.xtc_image(DIR_WS_ICONS.'novalnet/novalnet_paypal.png', "PayPal").'</a>':''));
...
define('MODULE_PAYMENT_NOVALNET_PP_SAVECARD_DETAILS', 'Save my PayPal details for future purchases');

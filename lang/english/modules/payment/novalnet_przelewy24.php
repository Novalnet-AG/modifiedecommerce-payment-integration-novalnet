...
define('MODULE_PAYMENT_NOVALNET_PRZELEWY24_TEXT_DESCRIPTION', '<br>After the successful verification, you will be redirected to Novalnet secure order page to proceed with the payment<br/>');
define('MODULE_PAYMENT_NOVALNET_PRZELEWY24_PUBLIC_TITLE', (((!defined('MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY')) || MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY == 'True') ? '<a href="https://www.novalnet.com/przelewy24" title="Przelewy24" target="_blank"/>'.xtc_image(DIR_WS_ICONS.'novalnet/novalnet_przelewy24.png', "Przelewy24").'</a>':''));

...
define('MODULE_PAYMENT_NOVALNET_PP_TEXT_DESCRIPTION', '<br>Nach der erfolgreichen &Uuml;berpr&uuml;fung werden Sie auf die abgesicherte Novalnet-Bestellseite umgeleitet, um die Zahlung fortzusetzen<br />');
define('MODULE_PAYMENT_NOVALNET_PP_PUBLIC_TITLE', (((!defined('MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY')) || MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY == 'True') ? '<a href="https://www.novalnet.de/mit-paypal-weltweit-sicher-verkaufen" title="PayPal" target="_blank"/>'.xtc_image(DIR_WS_ICONS.'novalnet/novalnet_paypal.png', "PayPal").'</a>':''));
...
define('MODULE_PAYMENT_NOVALNET_PP_SAVECARD_DETAILS', 'Meine PayPal-Daten für zukünftige Bestellungen speichern');
...
define('MODULE_PAYMENT_NOVALNET_PP_CAPTURE_AUTHORIZE_TITLE', 'Zahlungsvorgang');
define('MODULE_PAYMENT_NOVALNET_PP_CAPTURE_AUTHORIZE_DESC', '');
define('MODULE_PAYMENT_NOVALNET_PP_CAPTURE_AUTHORIZE_CAPTURE', 'Erfassung');
define('MODULE_PAYMENT_NOVALNET_PP_CAPTURE_AUTHORIZE_AUTH', 'Genehmigen');

...
define('MODULE_PAYMENT_NOVALNET_SEPA_TEXT_DESCRIPTION', '<br>Ihr Konto wird nach Abschicken der Bestellung belastet<br />');
define('MODULE_PAYMENT_NOVALNET_SEPA_PUBLIC_TITLE', (((!defined('MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY')) || MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY == 'True')?'<a href="https://www.novalnet.de/sepa-lastschrift" title="Lastschrift SEPA" target="_blank"/>'.xtc_image(DIR_WS_ICONS.'novalnet/novalnet_sepa.png', "Lastschrift SEPA").'</a>':''));
...
define('MODULE_PAYMENT_NOVALNET_SEPA_FORM_MANDATE_CONFIRM_TEXT', '<strong><a id="sepa_mandate_toggle"  style="color:#0080c9;">Ich erteile hiermit das SEPA-Lastschriftmandat (elektronische &Uuml;bermittlung) und best&auml;tige, dass die Bankverbindung korrekt ist.</a></strong><div id="sepa_mandate_details" style="display:none"><p> Ich erm&auml;chtige den Zahlungsempfänger, Zahlungen von meinem Konto mittels Lastschrift einzuziehen. Zugleich weise ich mein Kreditinstitut an, die von dem Zahlungsempfänger auf mein Konto gezogenen Lastschriften einzul&ouml;sen.</p> <p><strong>Gl&auml;ubiger-Identifikationsnummer: DE53ZZZ00000004253</strong></p> <p><strong>Hinweis:</strong> Ich kann innerhalb von acht Wochen, beginnend mit dem Belastungsdatum, die Erstattung des belasteten Betrages verlangen. Es gelten dabei die mit meinem Kreditinstitut vereinbarten Bedingungen.
</p></div>');
...
define('MODULE_PAYMENT_NOVALNET_SEPA_SAVECARD_DETAILS', 'Meine Kontodaten für zukünftige Bestellungen speichern');
...
define('MODULE_PAYMENT_NOVALNET_SEPA_CAPTURE_AUTHORIZE_TITLE', 'Zahlungsvorgang');
define('MODULE_PAYMENT_NOVALNET_SEPA_CAPTURE_AUTHORIZE_DESC', '');
define('MODULE_PAYMENT_NOVALNET_SEPA_CAPTURE_AUTHORIZE_CAPTURE', 'Erfassung');
define('MODULE_PAYMENT_NOVALNET_SEPA_CAPTURE_AUTHORIZE_AUTH', 'Genehmigen');
define('MODULE_PAYMENT_NOVALNET_SEPA_ZERO_AMOUNT_COMMENTS', '<span style="color: red;"><br/>Diese Bestellung wird als Null-Betrag-Buchung bearbeitet, in der Ihre Zahlungsdaten f&uuml;r weitere Online-Eink&auml;ufe gespeichert werden</span>');

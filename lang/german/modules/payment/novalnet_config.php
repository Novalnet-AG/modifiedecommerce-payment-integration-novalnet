...
define('MODULE_PAYMENT_NOVALNET_CONFIG_TEXT_DESCRIPTION', '<span style="font-weight: bold; color:#878787;">Bevor Sie beginnen, lesen Sie bitte die Installationsanleitung und melden Sie sich mit Ihrem H&auml;ndlerkonto im <a href="https://admin.novalnet.de" target="_blank" style="text-decoration: underline; font-weight: bold; color:#0080c9;">Novalnet Admin-Portal</a> an. Um ein H&aumlndlerkonto zu erhalten, senden Sie bitte eine E-Mail an <a style="font-weight: bold; color:#0080c9" href="mailto:sales@novalnet.de">sales@novalnet.de</a> oder rufen Sie uns unter +49 89 923068320 an</span><br/><br/><span style="font-weight: bold; color:#878787;">Um PayPal-Transaktionen zu akzeptieren, konfigurieren Sie Ihre PayPal-API-Informationen im <a href="https://admin.novalnet.de" target="_blank" style="text-decoration: underline; font-weight: bold; color:#0080c9;">Novalnet Admin-Portal</a>> Projekte > Wählen Sie Ihr Projekt > Zahlungsmethoden > Paypal > Konfigurieren </span>');
define('MODULE_PAYMENT_NOVALNET_PUBLIC_KEY_TITLE', ' Produktaktivierungsschl&uuml;ssel');
define('MODULE_PAYMENT_NOVALNET_PUBLIC_KEY_DESC', ' Ihren Produktaktivierungsschlüssel finden Sie im <a href="https://admin.novalnet.de" target="_blank" style="text-decoration: underline; font-weight: bold; color:#0080c9;">Novalnet Admin-Portal</a>: Projekte > W&auml;hlen Sie Ihr Projekt > API-Anmeldeinformationen > API Signature (Produktaktivierungsschl&uuml;ssel)');

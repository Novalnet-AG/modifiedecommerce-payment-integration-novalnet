...
define('MODULE_PAYMENT_NOVALNET_SOFORTBANK_TEXT_DESCRIPTION', '<br>Nach der erfolgreichen &Uuml;berpr&uuml;fung werden Sie auf die abgesicherte Novalnet-Bestellseite umgeleitet, um die Zahlung fortzusetzen<br />');
define('MODULE_PAYMENT_NOVALNET_SOFORTBANK_PUBLIC_TITLE', (((!defined('MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY')) || MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY == 'True') ? '<a href="https://www.novalnet.de/online-ueberweisung-sofortueberweisung" title="Sofort " target="_blank"/>'.xtc_image(DIR_WS_ICONS.'novalnet/novalnet_instantbank.png', "Sofort").'</a>':''));

...
define('MODULE_PAYMENT_NOVALNET_SOFORTBANK_TEXT_TITLE', 'Sofort&uuml;berweisung ');
define('MODULE_PAYMENT_NOVALNET_SOFORTBANK_TEXT_DESCRIPTION', '<br> Sie werden zu Sofort&uuml;berweisung weitergeleitet. Um eine erfolgreiche Zahlung zu gew&auml;hrleisten, darf die Seite nicht geschlossen oder neu geladen werden, bis die Bezahlung abgeschlossen ist<br />');

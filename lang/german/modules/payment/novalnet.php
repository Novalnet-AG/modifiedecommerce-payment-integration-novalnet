...
define('MODULE_PAYMENT_NOVALNET_ONECLICK_SEPA_REF', 'Neue Kontodaten eingeben');
...
define('MODULE_PAYMENT_NOVALNET_ENABLE_MODULE_TITLE', 'Zahlungsart aktivieren');
...
define('MODULE_PAYMENT_NOVALNET_MANUAL_CHECK_LIMIT_TITLE', '<div id="set_limit_title">Mindesttransaktionslimit f&uuml;r Autorisierung</div>');
define('MODULE_PAYMENT_NOVALNET_MANUAL_CHECK_LIMIT_DESC', '<div id="set_limit_desc">Falls der Bestellbetrag das angegebene Limit &uuml;berschreitet, wird die Transaktion bis zu Ihrer Best&auml;tigung der Transaktion als angehalten gesetzt. Sie k&ouml;nnen das Feld leer lassen, wenn Sie alle Transaktionen als angehalten bearbeiten m&ouml;chten.</div>');
...
define('MODULE_PAYMENT_NOVALNET_PENDING_ORDER_STATUS_TITLE', 'Bestellstatus der ausstehenden Zahlung ');
define('MODULE_PAYMENT_NOVALNET_PENDING_ORDER_STATUS_DESC', '');
...
define('MODULE_PAYMENT_NOVALNET_VISIBILITY_BYAMOUNT_TITLE', 'Mindestwarenwert (in der kleinsten W&auml;hrungseinheit, z.B. 100 Cent = entsprechen 1.00 EUR)');
...
define('MODULE_PAYMENT_NOVALNET_INVPRE_REF1', '1.Verwendungszweck');
define('MODULE_PAYMENT_NOVALNET_INVPRE_REF2', '2.Verwendungszweck');
...
define('MODULE_PAYMENT_NOVALNET_REDIRECT_NOTICE_MSG', 'Bitte schlie&szlig;en Sie den Browser nach der erfolgreichen Zahlung nicht, bis Sie zum Shop zur&uuml;ckgeleitet wurden.<br />');
...
define('MODULE_PAYMENT_NOVALNET_GUARANTEE_MIN_AMOUNT_TITLE', 'Mindestbestellbetrag (in der kleinsten W&auml;hrungseinheit, z.B. 100 Cent = entsprechen 1.00 EUR)');
define('MODULE_PAYMENT_NOVALNET_GUARANTEE_MIN_AMOUNT_DESC', 'Diese Einstellung wird den Standardwert f&uuml;r den Mindestbestellbetrag &uuml;berschreiben. Beachten Sie, dass der Betrag im Bereich von 9,99 EUR.');
...
define('MODULE_PAYMENT_NOVALNET_GUARANTEE_FORCE_DESC', 'Falls die Zahlungsgarantie aktiviert ist (wahr), die oben genannten Anforderungen jedoch nicht erf&uuml;llt werden, soll die Zahlung ohne Zahlungsgarantie verarbeitet werden.');
define('MODULE_PAYMENT_NOVALNET_FORCE_GUARANTEE_ERROR_MESSAGE_COUNTRY', '<span style="color:red;">Die Zahlung kann nicht verarbeitet werden, da die grundlegenden Anforderungen für die Zahlungsgarantie nicht erfüllt wurden (Als Land ist nur Deutschland, Österreich oder Schweiz erlaubt)</span>');
define('MODULE_PAYMENT_NOVALNET_FORCE_GUARANTEE_ERROR_MESSAGE_CURRENCY', '<span style="color:red;">Die Zahlung kann nicht verarbeitet werden, da die grundlegenden Anforderungen für die Zahlungsgarantie nicht erfüllt wurden (Als Währung ist nur EUR erlaubt)</span>');
define('MODULE_PAYMENT_NOVALNET_FORCE_GUARANTEE_ERROR_MESSAGE_ADDRESS', '<span style="color:red;">Die Zahlung kann nicht verarbeitet werden, da die grundlegenden Anforderungen für die Zahlungsgarantie nicht erfüllt wurden (Die Lieferadresse muss mit der Rechnungsadresse übereinstimmen)</span>');
define('MODULE_PAYMENT_NOVALNET_FORCE_GUARANTEE_ERROR_MESSAGE_AMOUNT', '<span style="color:red;">Die Zahlung kann nicht verarbeitet werden, da die grundlegenden Anforderungen für die Zahlungsgarantie nicht erfüllt wurden (Der Mindestbestellwert beträgt %s)</span>');

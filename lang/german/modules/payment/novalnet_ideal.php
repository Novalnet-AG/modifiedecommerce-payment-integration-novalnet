...
define('MODULE_PAYMENT_NOVALNET_IDEAL_TEXT_DESCRIPTION', '<br>Nach der erfolgreichen &Uuml;berpr&uuml;fung werden Sie auf die abgesicherte Novalnet-Bestellseite umgeleitet, um die Zahlung fortzusetzen<br />');
define('MODULE_PAYMENT_NOVALNET_IDEAL_PUBLIC_TITLE', (((!defined('MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY')) || MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY == 'True') ? '<a href="https://www.novalnet.de/ideal-online-ueberweisung" title="iDEAL" target="_blank"/>'.xtc_image(DIR_WS_ICONS.'novalnet/novalnet_ideal.png', "iDEAL").'</a>':''));

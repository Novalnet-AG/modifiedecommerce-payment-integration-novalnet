...
if (isset($_SESSION['novalnet'][$novalnet_payment]['input_params'])) {
    ...
    $form_action_url = ['novalnet_giropay' => 'https://payport.novalnet.de/giropay',
     ...
     $description = ($_SESSION['payment'] == 'novalnet_cc') ? defined("MODULE_PAYMENT_" . strtoupper($_SESSION['payment']) . "_REDIRECTION_TEXT_DESCRIPTION") : constant("MODULE_PAYMENT_" . strtoupper($_SESSION['payment']) . "_TEXT_DESCRIPTION");

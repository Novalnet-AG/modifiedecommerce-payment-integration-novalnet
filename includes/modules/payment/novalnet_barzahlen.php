    ...
    public function process_button()
    {
        ...
        if (isset($_SESSION['novalnet'][$this->code]['order_amount'])) {
          ...
          // Displaying error message
			$payment_error_return = 'payment_error=' . $this->code . '&error=' . urlencode(MODULE_PAYMENT_NOVALNET_AMOUNT_ERROR_MESSAGE);
  ...
  '.MODULE_PAYMENT_NOVALNET_BARZAHLEN_BUTTON.'
    ...
    public function install()
    {
        if (NovalnetUtil::globalConfigInstallError($this->code)) {
            ...
            ('MODULE_PAYMENT_NOVALNET_BARZAHLEN_STATUS', 'False',  '6', '1', 'xtc_cfg_select_option(array(\'True\', \'False\'), ','', now()),
            ('MODULE_PAYMENT_NOVALNET_BARZAHLEN_TEST_MODE', 'False',  '6', '2', 'xtc_cfg_select_option(array(\'True\', \'False\'), ','', now()),

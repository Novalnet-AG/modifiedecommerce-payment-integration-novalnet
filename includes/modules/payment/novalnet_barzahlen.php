    ...
    public function install()
    {
        if (NovalnetUtil::globalConfigInstallError($this->code)) {
		  ...
		  VALUES
			...
			('MODULE_PAYMENT_NOVALNET_BARZAHLEN_ORDER_STATUS', '1',  '6', '7', 'xtc_cfg_pull_down_order_statuses(', 'xtc_get_order_status_name', now()),
			('MODULE_PAYMENT_NOVALNET_BARZAHLEN_CALLBACK_ORDER_STATUS', '1',  '6', '8', 'xtc_cfg_pull_down_order_statuses(', 'xtc_get_order_status_name', now()),

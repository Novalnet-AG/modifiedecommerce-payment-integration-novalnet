...
class novalnet_ideal extends NovalnetPayment
{
    ...
    public function install()
    {
        if (NovalnetUtil::globalConfigInstallError($this->code)) {
            ...
            ('MODULE_PAYMENT_NOVALNET_IDEAL_STATUS', 'False',  '6', '1', 'xtc_cfg_select_option(array(\'True\', \'False\'), ','', now()),
            ('MODULE_PAYMENT_NOVALNET_IDEAL_TEST_MODE', 'False',  '6', '2', 'xtc_cfg_select_option(array(\'True\', \'False\'), ','', now()),

...
{
    var $title,$description,$code,$enabled,$sort_order;
    ...
    public function install()
    {
        ...
        ('MODULE_PAYMENT_NOVALNET_CALLBACK_TEST_MODE', 'False',  '6', '9', 'xtc_cfg_select_option(array(\'True\', \'False\'), ','', now()),
        ('MODULE_PAYMENT_NOVALNET_CALLBACK_MAIL_SEND', 'False',  '6', '10', 'xtc_cfg_select_option(array(\'True\', \'False\'), ','', now()),

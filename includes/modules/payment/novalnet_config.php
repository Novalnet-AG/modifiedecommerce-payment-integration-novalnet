...
class novalnet_config
{
    ...
    public function install()
    {
        ...
        ('MODULE_PAYMENT_NOVALNET_PAYMENT_ACCESS_KEY', '', '6', '5', '', '', now()),
         ('MODULE_PAYMENT_NOVALNET_LAST_SUCCESSFUL_PAYMENT_SELECTION','False', '6', '6', 'xtc_mod_select_option(array(\'True\' => MODULE_PAYMENT_NOVALNET_TRUE,\'False\' => MODULE_PAYMENT_NOVALNET_FALSE),\'MODULE_PAYMENT_NOVALNET_LAST_SUCCESSFUL_PAYMENT_SELECTION\',".MODULE_PAYMENT_NOVALNET_LAST_SUCCESSFUL_PAYMENT_SELECTION.",' , '',now()),
        ('MODULE_PAYMENT_NOVALNET_PROXY', '', '6', '7', '', '', now()),
        ('MODULE_PAYMENT_NOVALNET_GATEWAY_TIMEOUT', '240', '6', '8', '', '', now()),
        ('MODULE_PAYMENT_NOVALNET_REFERRER_ID', '', '6', '9', '', '', now()),
        ('MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY','True', '6', '10', 'xtc_mod_select_option(array(\'True\' => MODULE_PAYMENT_NOVALNET_TRUE,\'False\' => MODULE_PAYMENT_NOVALNET_FALSE),\'MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY\',".MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY.",' , '',now()),
        ('MODULE_PAYMENT_NOVALNET_ONHOLD_ORDER_COMPLETE', '0',  '6', '11', 'xtc_cfg_pull_down_order_statuses(', 'xtc_get_order_status_name', now()),
        ('MODULE_PAYMENT_NOVALNET_ONHOLD_ORDER_CANCELLED', '0',  '6', '12', 'xtc_cfg_pull_down_order_statuses(', 'xtc_get_order_status_name',now()),
        ('MODULE_PAYMENT_NOVALNET_CALLBACK_TEST_MODE','False', '6', '13', 'xtc_mod_select_option(array(\'True\' => MODULE_PAYMENT_NOVALNET_TRUE,\'False\' => MODULE_PAYMENT_NOVALNET_FALSE),\'MODULE_PAYMENT_NOVALNET_CALLBACK_TEST_MODE\',".MODULE_PAYMENT_NOVALNET_CALLBACK_TEST_MODE.",' , '',now()),
        ('MODULE_PAYMENT_NOVALNET_CALLBACK_MAIL_SEND','False', '6', '14', 'xtc_mod_select_option(array(\'True\' => MODULE_PAYMENT_NOVALNET_TRUE,\'False\' => MODULE_PAYMENT_NOVALNET_FALSE),\'MODULE_PAYMENT_NOVALNET_CALLBACK_MAIL_SEND\',".MODULE_PAYMENT_NOVALNET_CALLBACK_MAIL_SEND.",' , '',now()),
        ('MODULE_PAYMENT_NOVALNET_CALLBACK_MAIL_TO', '', '6', '15','','', now()),
        ('MODULE_PAYMENT_NOVALNET_CALLBACK_MAIL_BCC', '', '6', '16','','', now()),
        ('MODULE_PAYMENT_NOVALNET_CALLBACK_URL', '".((($request_type == 'SSL') ? HTTPS_SERVER : HTTP_SERVER) . DIR_WS_CATALOG) . 'callback/novalnet/callback.php'."','6', '17','','', now()),
        ('MODULE_PAYMENT_NOVALNET_CONFIG_ALLOWED', '', '6', '18','','', now()),
        ('MODULE_PAYMENT_NOVALNET_PAYMENT_PENDING_STATUS', '". $tmp_status_id ."', '6', '19','','', now())");
    }
    ...
    public function keys()
    {
        ...
        return array (
            ...
            'MODULE_PAYMENT_NOVALNET_LAST_SUCCESSFUL_PAYMENT_SELECTION',

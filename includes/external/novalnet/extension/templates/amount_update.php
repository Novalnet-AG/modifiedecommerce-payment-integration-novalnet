			...
			<tr  class="dataTableRow">
				...
				<td class="dataTableContent" valign="top">
					<div class="flt-r">
						...
						<input type='submit' class="button" name='nn_trans_confirm' value='<?php echo MODULE_PAYMENT_NOVALNET_UPDATE_TEXT; ?>' onclick="return validate_amount_change(<?php echo $this->data['payment_id']?>);" />
					</div>
				</td>
			</tr>
		</table>
